...
// ─── Anti-DPI: SPA (Single Packet Authorization) — Getters & Setters ──────────

// GetSpaEnable وضعیت فعال/غیرفعال بودن SPA را برمی‌گرداند
func (s *SettingService) GetSpaEnable() (bool, error) {
	value, err := s.getString("spaEnable")
	if err != nil {
		return false, err
	}
...
// SetSpaEnable وضعیت فعال/غیرفعال SPA را ذخیره می‌کند
func (s *SettingService) SetSpaEnable(value string) error {
	return s.saveSetting("spaEnable", value)
}

// GetSpaPort پورت UDP مخفی SPA را برمی‌گرداند
func (s *SettingService) GetSpaPort() (int, error) {
	value, err := s.getString("spaPort")
	if err != nil {
		return 62201, err
	}
	port, err := strconv.Atoi(value)
	if err != nil || port < 1 || port > 65535 {
		return 62201, nil // مقدار پیش‌فرض
	}
	return port, nil
}

// SetSpaPort پورت UDP مخفی SPA را ذخیره می‌کند
func (s *SettingService) SetSpaPort(value string) error {
	return s.saveSetting("spaPort", value)
}

// GetSpaKey کلید Pre-Shared Key SPA را برمی‌گرداند (Base64)
func (s *SettingService) GetSpaKey() (string, error) {
	return s.getString("spaKey")
}

// SetSpaKey کلید Pre-Shared Key SPA را ذخیره می‌کند
func (s *SettingService) SetSpaKey(value string) error {
	return s.saveSetting("spaKey", value)
}

// GetSpaMainPort پورت اصلی که SPA باید باز/بسته کند را برمی‌گرداند
func (s *SettingService) GetSpaMainPort() (int, error) {
	value, err := s.getString("spaMainPort")
	if err != nil {
		return 443, err
	}
	port, err := strconv.Atoi(value)
...
// SetSpaMainPort پورت اصلی SPA را ذخیره می‌کند
func (s *SettingService) SetSpaMainPort(value string) error {
	return s.saveSetting("spaMainPort", value)
}

// GetSpaWindowSeconds مدت زمان باز ماندن پورت برای IP کلاینت را برمی‌گرداند
func (s *SettingService) GetSpaWindowSeconds() (int, error) {
	value, err := s.getString("spaWindowSeconds")
	if err != nil {
		return 60, err
	}
...
// SetSpaWindowSeconds مدت زمان window SPA را ذخیره می‌کند
func (s *SettingService) SetSpaWindowSeconds(value string) error {
	return s.saveSetting("spaWindowSeconds", value)
}

// GetSpaTimestampTolerance حداکثر اختلاف timestamp مجاز را برمی‌گرداند
func (s *SettingService) GetSpaTimestampTolerance() (int, error) {
	value, err := s.getString("spaTimestampTolerance")
	if err != nil {
		return 30, err
	}
	sec, err := strconv.Atoi(value)
...
// SetSpaTimestampTolerance مقدار tolerance زمانی SPA را ذخیره می‌کند
func (s *SettingService) SetSpaTimestampTolerance(value string) error {
	return s.saveSetting("spaTimestampTolerance", value)
}

// ─── Anti-DPI: SRTP/RTP Tunnel — Getters & Setters ──────────────────────────

// GetSrtpEnable وضعیت فعال/غیرفعال بودن تونل SRTP را برمی‌گرداند
func (s *SettingService) GetSrtpEnable() (bool, error) {
	value, err := s.getString("srtpEnable")
	if err != nil {
		return false, err
	}
	return value == "true", nil
...
// SetSrtpEnable وضعیت فعال/غیرفعال بودن تونل SRTP را ذخیره می‌کند
func (s *SettingService) SetSrtpEnable(value string) error {
	return s.saveSetting("srtpEnable", value)
}

// GetSrtpPort پورت شنیداری تونل SRTP را برمی‌گرداند
func (s *SettingService) GetSrtpPort() (int, error) {
	value, err := s.getString("srtpPort")
	if err != nil {
		return 3478, err
	}
	port, err := strconv.Atoi(value)
...
// SetSrtpPort پورت شنیداری تونل SRTP را ذخیره می‌کند
func (s *SettingService) SetSrtpPort(value string) error {
	return s.saveSetting("srtpPort", value)
}

// GetSrtpTargetPort پورت xray-core مقصد را برمی‌گرداند
func (s *SettingService) GetSrtpTargetPort() (int, error) {
	value, err := s.getString("srtpTargetPort")
	if err != nil {
		return 443, err
	}
	port, err := strconv.Atoi(value)
...
// SetSrtpTargetPort پورت xray-core مقصد را ذخیره می‌کند
func (s *SettingService) SetSrtpTargetPort(value string) error {
	return s.saveSetting("srtpTargetPort", value)
}

// GetSrtpKey کلید رمزنگاری RC4 تونل SRTP را برمی‌گرداند
func (s *SettingService) GetSrtpKey() (string, error) {
	return s.getString("srtpKey")
}
